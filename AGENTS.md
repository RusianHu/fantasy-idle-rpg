...
- 本项目通过 `C:\Users\admin\Desktop\VPS\yanshanlaosiji_ssh_root.ps1` 部署到我的VPS的 `/www/wwwroot/yanshanlaosiji.top/fantasy-idle-rpg` ，可通过 https://yanshanlaosiji.top/fantasy-idle-rpg 访问，我默认用这个方式游玩和分发。
