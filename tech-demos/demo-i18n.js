...
(function () {
  ...
  var messages = {
    'zh-CN': {
      ...
      'hub.overview': '当前能力',
      'hub.overviewValue': '开放探索 v3 · 存档 v11 · 五职业 · 动态交易域',
      'hub.units.title': '角色与怪物',
      'hub.units.desc': '按八张主题地图自动枚举职业、普通怪与 Boss，并验证正式战斗、动作气泡和技能表现。',
      'hub.map.title': '世界现场',
    ...
    en: {
      ...
      'hub.overviewValue': 'Open exploration v3 · save v11 · five classes · dynamic trade areas',
      'hub.units.title': 'Units & Combat',
      'hub.units.desc': 'Auto-discovers classes, enemies and bosses across all eight theme maps, with production combat, bubbles and skills.',
