...
vm.runInContext(read('js/core/registry.js'), sandbox, { filename: 'js/core/registry.js' });
vm.runInContext(read('js/data/regions.js'), sandbox, { filename: 'js/data/regions.js' });
