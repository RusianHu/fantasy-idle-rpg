...
(function () {
  ...
  Game.i18n.addPack('en', {
    ui: {
      ...
      guardRevealed: 'You detected the ambush guard near the target.',
      guardAmbush: 'A concealed guard ambushed you; the interaction was safely cancelled.',
      guardEngaged: 'A guard has locked the target until combat ends.',
      guardCleared: 'The guard is cleared and the target is now unlocked.',
      guardLocked: 'This target is still locked by a guard.',
      bossGateLocked: 'The Boss entrance is still locked by its gate guard.',
      nestDiscovered: 'You discovered a semi-open monster nest.',
      nestChestOpened: 'Nest chest: {gold} gold and {count} regional materials.',
